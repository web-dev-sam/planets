...
const [[cloudTransform, cloudCopyTransform], [dustTransform, dustCopyTransform]] = usePlanetAnimation([
    {
        start: -450,
        end: 450,
        speed: props.rotation / 1000,
    },
    {
        start: -450,
        end: 450,
        speed: props.rotation / 2000,
    },
]);
</script>
...
<template>
    <div
        class="absolute top-[50%] h-[30vw] max-h-[400px] w-[30vw] max-w-[400px] translate-y-[-50%] !overflow-hidden rounded-full"
    >
        <svg
        ...
        >
            ...
            <g transform="translate(201 7)" v-show="internalShown">
                <mask id="h" fill="#fff">
                    <use xlink:href="#g" />
                </mask>
    ...
    <div class="relative w-full h-full xl:scale-100 md:scale-75 xs:scale-50 mb-[250px]">
        <img v-show="surfaceShown" src="/images/geology-venus.png" class="absolute w-[170px] h-auto top-1/2 left-1/2 -translate-x-1/2 translate-y-10" />
    </div>
</template>
