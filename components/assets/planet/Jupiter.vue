...
const [
    [dust1Transform, dust1CopyTransform],
    [dust2Transform, dust2CopyTransform],
    [dust3Transform, dust3CopyTransform],
    [dust4Transform, dust4CopyTransform],
    [dust5Transform, dust5CopyTransform],
] = usePlanetAnimation([
    {
        start: -700,
        end: 700,
        speed: -props.rotation,
    },
    {
        start: -700,
        end: 700,
...
<template>
    <div
        class="absolute top-[50%] h-[30vw] max-h-[500px] w-[30vw] max-w-[500px] translate-y-[-50%] !overflow-hidden rounded-full"
    >
        <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 582 582">
    ...
    <div class="relative w-full h-full xl:scale-100 md:scale-75 xs:scale-50 mb-[250px]">
        <img v-show="surfaceShown" src="/images/geology-jupiter.png" class="absolute w-[170px] h-auto top-1/2 left-1/2 -translate-x-1/2 translate-y-10" />
    </div>
</template>
