...
const [
    ...
    },
    {
        ...
        speed: props.rotation * 2,
        direction: "vertical",
    },
    {
        start: -450,
        end: 900,
        speed: props.rotation * 3,
        direction: "vertical",
    },
]);
</script>
...
<template>
    ...
    >
        <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 458 458">
    ...
    <div class="relative w-full h-full xl:scale-100 md:scale-75 xs:scale-50 mb-[250px]">
        <img v-show="surfaceShown" src="/images/geology-uranus.png" class="absolute w-[170px] h-auto top-1/2 left-1/2 -translate-x-1/2 translate-y-10" />
    </div>
</template>
