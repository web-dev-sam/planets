...
const [[sinusTransform, _], [sinus2Transform, __]] = usePlanetAnimation([
    {
        start: -300,
        end: 300,
        height: 15,
        speed: 0.01,
        direction: "sinus-vertical",
    },
    {
        start: -300,
        end: 300,
...
<template>
    <div class="absolute top-[50%] h-[30vw] max-h-[450px] w-[30vw] max-w-[450px] translate-y-[-50%]">
        <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 668 668">
            <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                ...
                fill="#B87D43"
                :transform="sinusTransform"
            />
            <circle cx="334" cy="318" r="208" fill="#FCCB6B" :transform="sinus2Transform" />
            <mask id="a" maskUnits="userSpaceOnUse" x="126" y="110" width="416" height="416">
                <circle cx="334" cy="318" r="208" fill="#fff" :transform="sinus2Transform" />
            </mask>
            <g mask="url(#a)">
                <path
                    fill-rule="evenodd"
                    ...
                    fill="#ECB55A"
                    :transform="sinus2Transform"
                />
            </g>
            <g :transform="sinus2Transform">
            ...
            <g v-show="internalShown" :transform="sinus2Transform">
                <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
    ...
    <div class="relative h-full w-full xl:scale-100 md:scale-75 xs:scale-50 mb-[250px]">
        <img
            v-show="surfaceShown"
            src="/images/geology-saturn.png"
            class="absolute top-1/2 left-1/2 h-auto w-[160px] -translate-x-1/2 translate-y-10"
            :style="`translate: 0 ${sinusTransform.split(' ')[1].replace(')', '')}px`"
        />
    </div>
</template>
